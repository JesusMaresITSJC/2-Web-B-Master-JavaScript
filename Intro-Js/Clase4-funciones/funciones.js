...
//return da el valor para usarlo despues en alguna variable
saludar("Jesus");
...
//errores
console.log(multiplicar(4)); //Nan - le hace falta un parametro
//console.log(Jesus);
...
/*
se tiene que reutilizar varias veces la funcion
tiene logica grande
